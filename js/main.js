...
'es':['esperando por la primera transacción...','vea las monedas del mundo corriendo al BTC en tiempo real','Cada transacción hace un Bitcoin que esta enviado de la moneda FIAT en rojo a su pais.  El valor en BTC esta muestra en verde y trazada através del mapa.  El ultimo precio por cada moneda esta muestra en color morado y actualizado por cada transacción','¿Ocultar animaciones?','¿Reproducir sonido cuando la tasa es','BTC por segundo o superior?','Datos de','donar bitcoins para apoyar el desarrollo de código abierto'],
