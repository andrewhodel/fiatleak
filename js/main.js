...
'sl':['čakanje na prvi posel ...','opazuj prelivanje svetovnih valut v BTC v realnem času','Pri vsakem sklenjenem poslu se Bitcoin premakne iz valutnega števca rdeče barve v državo na zemljevidu. Vrednost v BTC je navedena v zeleni barvi na zemljevidu. Zadnji menjalni tečaj za vsako od valut je naveden v vijolični barvi in posodobljen po vsakem sklenjenem poslu.','Skrijem animacije?','Predvajam zvok pri nakupu','BTC na sekundo ali več?','Podatki iz','darujte Bitcoine za podporo razvoja odprtokodne aplikacije']
}
